  ...
  try {
    ...
    if (body.newPassword) {
      ...
      if (currentHash) {
        ...
        // First time setting password: allow empty currentPassword for an
        // already-authenticated local setup, or require the configured bootstrap
        // password when one is supplied.
